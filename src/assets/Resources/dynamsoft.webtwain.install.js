...
Dynamsoft.OnLTSConnectionFailure = function () {
  ...
  var ObjString = [], ex = Dynamsoft.DWT.licenseException;

  ObjString = [
    '<div class="dynamsoft-dialog dynamsoft-dialog2">',
    '<div class="dynamsoft-dwt-ltsdlg-header"><i class="dynamsoft-dwt-error"></i></div>',
    '<div class="dynamsoft-dwt-ltsdlg-body">',
    'You are seeing this dialog because Dynamic Web TWAIN has failed to connect to the License Tracking Server. ',
    'Please make sure you can connect to the network. ',
    'If you changed the default License Tracking Server configuration, ',
    'please make sure it is correct. For more information, please check out this ',
    '<a class="dynamsoft-major-color" href="https://www.dynamsoft.com/license-tracking/docs/common/mechanism.html?ver=latest">article</a>.',
    '<br />',
    '<div>Email <a class="dynamsoft-major-color" href="mailto:support@dynamsoft.com">support@dynamsoft.com</a> for more information.</div>',
    '</div></div>'
  ];
...
Dynamsoft.OnLTSReturnedAnError = function () {
  ...
  var ObjString = [], ex = Dynamsoft.DWT.licenseException, msg = ex.message;
...
Dynamsoft.OnLTSConnectionWarning = function () {
  ...
  var bHideCloseButton = false, 
    ObjString = [], ex = Dynamsoft.DWT.licenseException;

  ObjString = [
    '<div class="dynamsoft-dialog dynamsoft-dialog2">',
    '<div class="dynamsoft-dwt-ltsdlg-header"><i class="dynamsoft-dwt-warning"></i><div class="dynamsoft-dialog-close">x</div></div>',
    '<div class="dynamsoft-dwt-ltsdlg-body">',
